...
export class ContactsController extends ClassEvent {
    ...
    constructor(modalElement, user){
        ...
        this._contactListElement = document.querySelector('#contact-list');

    }

    async open(){

        this._contactListElement.innerHTML = '';

        try {

            let contacts = await this._user.getContacts();
            ...
            contacts.forEach( (contact) => {
                ...
                div.style = "z-index: 427; height: 72px; display: contents;";
                ...
                this._contactListElement.appendChild(div);
